    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.GET, "/roles").hasAnyRole("USER", "ADMIN", "BREWER")
                        .requestMatchers(HttpMethod.GET, "/users").permitAll()
                        .requestMatchers(HttpMethod.GET, "/users/{username}").hasAnyRole("USER", "ADMIN", "BREWER")
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/products/{productName}").hasAnyRole("ADMIN", "BREWER")
